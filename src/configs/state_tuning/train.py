...
class TrainConfig:
    ...
    def __init__(self) -> None:
        ...
        # 训练 epoch / step 控制
        self.epoch_steps: int = 800
        self.epoch_count: int = 10
        self.epoch_begin: int = 0
        self.epoch_save: int = 1

        # 批大小 & 并行设置
        self.ctx_len: int = 512
        self.micro_bsz: int = 2
        ...
        # 优化器参数
        self.lr_init: float = 1.0
        self.lr_final: float = 1e-2
        ...
        self.disha_config: dict = {"mode": "mode", "load": "", "r": 64}
        ...
        # FLA / 训练类型
        self.fla: bool = False
        self.train_type: str = "state"  # state / infctx / none
